...
int main() {
	...
	int el = 15, sl = 28, ml = 19;
	int er = translate(e, el);
	int sr = translate(s, sl);
	int mr = translate(m, ml);
...
//		cout << y << endl;
		cnt ++;
		int tempS = translate(y, sl);
		int tempM = translate(y, ml);
		if(sr == tempS && mr == tempM)
			break;
	}
	cout << y << endl;
